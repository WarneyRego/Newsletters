...
import { Calendar, Clock, Trash2, Share2 } from 'lucide-react';
    ...
    >
      <div className="relative">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 z-30">
          <motion.h1 
            className="text-3xl md:text-5xl font-bold text-white font-newspaper leading-tight"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex items-center gap-3 mt-4 sm:mt-0">
            {onDeleteClick && isAdminMode && (
              <motion.button
                ...
                className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md flex items-center space-x-2 shadow-sm"
      ...
      >
        ...
        <div className="mt-10 pt-6 border-t border-gray-100">
          <h3 className="text-lg font-bold text-gray-900 mb-4 font-newspaper">Compartilhe esta notícia</h3>
